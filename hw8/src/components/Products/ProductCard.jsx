...
const ProductCard = ({ id, cardLink, img, addLink, title, price, btnText, sizes }) => {
    ...
    return (
                <div class="product__cards__content__item">
                    <div className="cards__block" key={id}>
                        <a className="cards__link" href={cardLink}>
                            <img className="card__img" src={img} alt="product" />
                            <p className="card__name">{title}</p>
                            <div className="card__block">
                                <p className="card__price">$ {price}</p>
                                <p className="card__sizes">{sizes}</p>
                            </div>                            
                        </a>
                        <div className="add-box">
                            <a id={id} className="add" href='#' onClick={handleAddToBasket}>
